    ...
    return (
        <div>
            ...
            <div className="mt-20 pt-3">
                <h1 className="text-4xl font-bold text-center text-dark-primary">Designs</h1>
            </div>
                ...
                {classes.map((cls, index) => (
                    ...
                    >
                        ...
                        <div className="px-6 py-2">
                            ...
                            <p className="text-gray-500 text-xs">Designer : {cls.instructorName}</p>
                            <div className="flex items-center justify-between mt-4">
                                <span className="text-gray-600 text-xs">Available Designs: <span className='text-secondary'>{cls.availableSeats}</span> </span>
