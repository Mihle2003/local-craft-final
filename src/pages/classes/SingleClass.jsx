...
import bannerImg1 from "../../assets/home/bannerr-2.jpeg";
          ...
          <div className="container">
            ...
            <div className="lg:col-span-8 col-span-12">
                <div className="single-course-details">
                  ...
                  <h2 className="text-2xl mb-2">Local Craft 2024</h2>
                    ...
                    <div id="tabs-content ">
                      ...
                      <div id="tab2" className="tab-content">
                        <div>
                          ...
                          <div>
                            <h4 className=" text-2xl">What You will Learn?</h4>
                            <p className="mt-4">The items are locally crafted with exceptional care and attention to detail, showcasing the beauty of artisanal craftsmanship. Each piece reflects the rich cultural heritage and creativity of local designers, making them truly unique. Beautifully made, these items stand as a testament to skill and passion, blending tradition with modern design.</p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="lg:col-span-4 col-span-12 mt-8 md:mt-0">
                <div className="sidebarWrapper space-y-[30px]">
                  ...
                  <div className="wdiget">
                    <h4 className=" widget-title">Related Designs</h4>
                    <ul className="list">
