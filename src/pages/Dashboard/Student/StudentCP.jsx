    ...
    return (
        <div className='h-screen flex justify-center items-center'>
            <div className="">
                ...
                <p className='text-center text-base'>Hey , This is a simple dashboard home . Our developer is trying to updating Dashboard </p>
                <div className="text-center">
                    ...
                    <div className="flex items-center justify-center my-4 gap-3">
                        ...
                        <div className="border border-secondary rounded-lg hover:bg-secondary hover:text-white duration-200 px-2 py-1">
                            <Link  to='/dashboard/apply-instructor'>Join as a Designer</Link>
                        </div>
                    </div>
                </div>
            </div>
