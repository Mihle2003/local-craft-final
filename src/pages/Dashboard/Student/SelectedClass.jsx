...
const SelectedClass = () => {
    useTitle('Selected Design | Local Craft selected design');
    ...
    return (
        <div>
            <div className="my-6">
                <h1 className='text-4xl text-center font-bold'>My <span className='text-secondary'>Selected</span> Design</h1>
            </div>
                        ...
                        <div className="md:w-3/4">
                            <div className="bg-white rounded-lg shadow-md p-6 mb-4">
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {
                                            classes.length === 0 ? <tr><td colSpan='5' className='text-center text-2xl font-bold'>No Designs Found</td></tr> : // If there is no item in the cart
