            ...
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
                <div className="flex px-4 items-center justify-between py-4">
                    ...
                    <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center">
                        <div className={``}>
                            <h1 className='text-2xl font-Cinzel  inline-flex gap-3  items-center font-bold'>Local Craft <img src="/yoga-logo.png" alt="" className='w-8 h-8' /></h1>
                            <p className='font-bold text-[13px]  tracking-[8px]'>Empowering local creativity</p>
                        </div>
                    </div>
